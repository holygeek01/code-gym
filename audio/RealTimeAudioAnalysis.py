import sys, os, pyalsaaudio, time, audioop, numpy, glob,  scipy, subprocess, wave, cPickle, threading, shutil
...
def main():
	duration = soundEventConfig.duration
	outputWavFile = soundEventConfig.outputWavFile
	modelName = 'svmModel'
	modelType = soundEventConfig.modelType
